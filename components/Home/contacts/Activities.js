                                ...
                                {data && data.map((row) => (
                                    <TableRow key={row.id}>
                                        ...
                                        <TableCell align="left" sx={{ borderBottom: 'none' }}>
                                            <Button  sx={{cursor: 'default', backgroundColor: '#EEEEEE', color: '#000', border: 'none', boxShadow: 'none', textTransform: 'none', borderRadius: '2px', width: '54px', height: '20px', fontSize: '12px', padding: '13px', '&:hover': { background: ' #EEEEEE' } }}>
                                                {row.by}
                                            </Button>
                                        </TableCell>
                                    </TableRow>
